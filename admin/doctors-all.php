                                ...
                                <table id="example1" class="table table-hover table-bordered table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="doctor-view.php?id=<?php echo $item['id'];?>" class="btn btn-info">View</a>
                                                <a href="doctor-update.php?id=<?php echo $item['id'];?>" class="btn btn-warning">Update</a>
                                                <a href="doctor-delete.php?id=<?php echo $item['id'];?>" class="btn btn-danger">delete</a>
