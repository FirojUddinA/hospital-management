...
<!-- ***** Header Area End ***** -->
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(frontend/img/bg-img/breadcumb1.jpg);">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="features-thumbnail">
                        <img src="frontend/img/bg-img/about1.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ***** Video Area Start ***** -->
    <section class="medilife-video-area section-padding-100 bg-overlay bg-img" style="background-image: url(frontend/img/bg-img/video.jpg);">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-lg-8">
                    <div class="video-box bg-overlay-black">
                        <img src="frontend/img/bg-img/video2.jpg" alt="">
                        <div class="play-btn">
                            <a class="popup-video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="frontend/img/core-img/play.png" alt=""></a>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="specialities" role="tabpanel" aria-labelledby="specialities-tab">
                                <div class="medilife-tab-content d-md-flex align-items-center">
                                    ...
                                    <!-- Medilife Tab Img  -->
                                    <div class="medilife-tab-img">
                                        <img src="frontend/img/bg-img/tab.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="footer-widget-area">
                            <div class="footer-logo">
                                <img src="frontend/img/core-img/logo.png" alt="">
                            </div>
                            ...
                            <div class="widget-blog-post">
                                ...
                                <div class="widget-single-blog-post d-flex">
                                    <div class="widget-post-thumbnail">
                                        <img src="frontend/img/blog-img/ln1.jpg" alt="">
                                    </div>
                                ...
                                <div class="widget-single-blog-post d-flex">
                                    <div class="widget-post-thumbnail">
                                        <img src="frontend/img/blog-img/ln2.jpg" alt="">
                                    </div>
                                    <div class="widget-post-content">
                                ...
                                <div class="widget-single-blog-post d-flex">
                                    <div class="widget-post-thumbnail">
                                        <img src="frontend/img/blog-img/ln3.jpg" alt="">
                                    </div>
                                    <div class="widget-post-content">
