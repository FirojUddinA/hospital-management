...
<!-- ***** Header Area End *****  -->
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(frontend/img/bg-img/breadcumb2.jpg);">
    ...
    <div class="medilife-services-area clearfix">
        ...
        <!-- Single Services Area -->
        <div class="singleServiceArea equalize bg-img" style="background-image: url(frontend/img/bg-img/about1.jpg);"></div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-benefits-thumb">
                        <img src="frontend/img/bg-img/benefits.png" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-4">
