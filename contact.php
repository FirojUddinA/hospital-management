...
<!-- ***** Header Area End ***** -->
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(frontend/img/bg-img/breadcumb3.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="content-sidebar">
                        ...
                        <div class="medilife-emergency-card bg-img bg-overlay" style="background-image: url(frontend/img/bg-img/about1.jpg);">
    ...
    <script src="frontend/js/map-active.js"></script>
